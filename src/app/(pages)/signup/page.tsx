...
import { registerErrorTypes } from '@/lib/types';
  ...
  return (
    <section className="bg-richblack min-h-screen flex items-center justify-center">
      <div className="px-4 py-12 sm:px-6 sm:py-16 lg:px-8 lg:py-24">
        <div className="xl:mx-auto xl:w-full xl:max-w-sm 2xl:max-w-md bg-smokyBlack rounded-lg shadow-md p-8 border-bistre">
          ...
          <form className="mt-8">
            <div className="space-y-5">
              <div>
                <label htmlFor="name" className="text-base font-medium text-rawNumber">
                  Full Name
                </label>
                <div className="mt-2">
                  <Input
              ...
              <div>
                ...
                <div className="mt-2 relative">
                  <Input
                    className="h-10 w-full rounded-md border border-rawNumber bg-transparent px-3 py-2 pr-12 text-sm text-white placeholder:text-seashell focus:outline-none focus:ring-1 focus:ring-rawnumber2 focus:ring-offset-1 disabled:cursor-not-allowed disabled:opacity-50"
                  ...
                  <button
                    ...
                    className="absolute inset-y-0 right-3 flex items-center bg-transparent text-seashell hover:text-rawnumber2"
                  >
                    {isPasswordVisible ? (
          ...
          <div className="mt-3 space-y-3">
            <button
              type="button"
              className="relative inline-flex w-full items-center justify-center rounded-md border border-rawnumber2 bg-white px-3.5 py-2.5 font-semibold text-gray-700 transition-all duration-200 hover:bg-gray-100 hover:text-black focus:bg-gray-100 focus:text-black focus:outline-none"
              onClick={googleLogin}
            >
